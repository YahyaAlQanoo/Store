<x-front-layout>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <form action="{{ route('cart.store') }}" method="post">
                                @csrf
                                <input type="hidden" name="product_id" data-id="{{ $product->id }}" value="{{ $product->id }}">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="form-group quantity">
                                            ...
                                            <select class="form-control" data-quantity="quantity" name="quantity">
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                                <option>4</option>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="button cart-button">
                                                <button type="submit" class="btn add-to-cart" style="width: 100%;">Add to
                                                    Cart</button>
                                            </div>
    ...
    <script src="{{ asset('build/assets/cart.6054201d.js') }}"></script>
    @endpush
